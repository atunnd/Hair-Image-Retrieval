...
def main():
    ...
    checkpoint_path = "/mnt/mmlab2024nas/thanhnd_student/QuocAnh/FCIR/Baselines/Composed-Image-Retrieval/experiments/DualViewHair/enhanced_model_MultiScale_Attention_epoch_40.pth"
