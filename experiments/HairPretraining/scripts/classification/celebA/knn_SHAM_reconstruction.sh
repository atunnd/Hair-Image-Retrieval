...
python knn_classification.py \
  ...
  --mode SHAM \
  --model vit_b_16 \
  --checkpoint_path /mnt/mmlab2024nas/thanhnd_student/QuocAnh/FCIR/Baselines/Composed-Image-Retrieval/experiments/HairPretraining/output_dir/SHAM_vit_b_16_reconstruction/model_ckpt_299.pth \
  --seed 42 \
  --num_workers 8 \
  --device cpu \
  --batch_size 256 \
