...
python knn_classification.py \
  ...
  --mode our \
  --model vit_b_16 \
  --checkpoint_path "/mnt/mmlab2024nas/thanhnd_student/QuocAnh/FCIR/Baselines/Composed-Image-Retrieval/experiments/HairPretraining/output_dir/vast_ai_vit/model_ckpt_199.pth" \
  --seed 42 \
  --num_workers 8 \
  --device cuda \
  --batch_size 256 \
