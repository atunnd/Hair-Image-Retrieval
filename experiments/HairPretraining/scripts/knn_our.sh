...
python knn_classification.py \
  ...
  --mode simclr \
  --model resnet50 \
  --checkpoint_path /mnt/mmlab2024nas/thanhnd_student/QuocAnh/FCIR/Baselines/Composed-Image-Retrieval/experiments/HairPretraining/output_dir/origin_simclr_resnet50_neg_sample_supervised_mse_static_alpha_patch_False_mlp/model_ckpt_19.pth \
  --seed 42 \
  --num_workers 8 \
  --device cuda \
  --batch_size 256 \
