...
class MaskedVisionTransformerTIMM(MaskedVisionTransformer):
    ...
    def forward(
        ...
        hair_region_idx: Optional[Tensor] = None,
    ) -> Tensor:
        x = self.encode(images, idx_mask=idx_mask, idx_keep=idx_keep, mask=mask, hair_region_idx=hair_region_idx)
