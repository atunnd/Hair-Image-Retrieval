...
def parse_args():
    ...
    # ViT settings
    parser.add_argument('--eval_type', default=None, type=str, choices=["knn", "linear_prob", "visualization", "inter_intra_distance"])
...
def main(args):
    ...
    elif args.eval_type == "inter_intra_distance":
        trainer.compute_intra_inter_variance(split="both")
