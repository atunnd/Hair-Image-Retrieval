...
python knn_classification.py \
  ...
  --mode simclr \
  --model resnet50 \
  --checkpoint_path /mnt/mmlab2024nas/thanhnd_student/QuocAnh/FCIR/Baselines/Composed-Image-Retrieval/experiments/HairPretraining/output_dir/simclr_resnet50/model_ckpt_latest.pth \
  --seed 42 \
  --num_workers 8 \
  --device cuda \
  --batch_size 256 \
